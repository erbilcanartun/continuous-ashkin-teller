...
def generate_phase_diagram_joblib(J_values, M_values, n_max_np=20, n_max_mp=10, 
    ...
    def process_one_point(J, M):
        J1 = J2 = J
        phase = identify_phase_hybrid(J1, J2, M, n_max_np=n_max_np, n_max_mp=n_max_mp, 
                                     n_rg_steps=n_rg_steps, b=b, d=d, history_length=history_length, dps=dps, only_mp=only_mp)
        return J, M, phase
